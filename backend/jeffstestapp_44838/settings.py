"""
Django settings for jeffstestapp_44838 project.
...
ROOT_URLCONF = 'jeffstestapp_44838.urls'
...
WSGI_APPLICATION = 'jeffstestapp_44838.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "jeffstestapp_44838 API",
    "DESCRIPTION": "API documentation for jeffstestapp_44838 App",
    "VERSION": "v1",
}
